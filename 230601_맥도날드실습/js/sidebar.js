...
// getElemnetsByClassName, getElentsById 앞에 . # 붙지 않는다.
// constgnbIconBtn = document.getElementsByClassName('클래스명');
// constgnbIconBtn = document.getElementsById('아이디명');
...
// 내가 gnbIconBtn한테 이벤트를 하나 추가할건데, => click 이벤트를 추가하고 openSidebar 이 함수를 실행시켜라
