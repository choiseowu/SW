    ...
    <>
      <section className={props.layout}>
        <div className={props.name}>
          ...
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque repellat officia voluptatum earum sint culpa quia animi maiores eos! Dignissimos.</p>
          {
            // html 조건부로 보여줄 때 
            // showBtn이 true일 때만 button을 랜더링 해준다. 
            // && (and) 우항, 좌항 둘 다 true일 경우 랜더링 
            // 좌항 false일 경우 바로 false 반환 (렌더링X)
